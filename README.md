...
- Results of sampled configurations and optimizer's internal information will be recorded in `record.log` and `pobo_record.log`. Here is an example output of in `record.log`:
  ```
